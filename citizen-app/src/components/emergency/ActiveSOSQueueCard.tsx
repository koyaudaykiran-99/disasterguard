...
export const ActiveSOSQueueCard: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="p-3.5 bg-red-950/70 rounded-2xl border border-red-500/60 space-y-2.5 shadow-lg shadow-red-950/40">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] uppercase px-2.5 py-0.5 rounded-full bg-red-500/30 text-white font-extrabold border border-red-500/40">
            {situation}
          </span>
        </div>
        ...
        <div className="text-xs text-rose-100 font-medium pt-1.5 border-t border-red-500/30 flex items-start gap-1.5">
          <span className="font-extrabold text-white">సూచన:</span>
          <span className="text-white font-medium">{situationGuidance.recommendedAction[language] || situationGuidance.recommendedAction.te}</span>
        </div>
      </div>
      ...
      {guidanceData && (guidanceData.recommended_shelter || guidanceData.recommended_hospital) && (
        <div className="p-3.5 bg-slate-950/80 rounded-2xl border border-emerald-500/50 space-y-2.5">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs text-cyan-300 hover:text-cyan-200 font-bold flex items-center gap-1 underline"
            >
      ...
      {/* Distress Summary */}
      <div className="p-3 bg-slate-950/80 rounded-xl border border-slate-700 space-y-2">
        <div className="flex items-center justify-between text-xs">
          <span className="text-slate-300 font-medium">Emergency ID:</span>
          <span className="text-white font-bold">{refCode}</span>
        </div>
        <div className="text-white text-xs font-semibold leading-relaxed bg-slate-900/80 p-2 rounded-lg border border-slate-800">
          "{activeSOS.message}"
        </div>
      ...
      <div className="space-y-2.5 pt-1 border-t border-slate-700/80">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-xs text-indigo-300 hover:text-indigo-200 font-bold underline"
          >
        ...
        <div className="grid grid-cols-2 gap-1.5">
          {QUICK_UPDATES.map((btn, idx) => (
            <button
              ...
              disabled={isSending}
              className="text-left px-2.5 py-2 rounded-lg bg-slate-900 hover:bg-slate-800 border border-slate-700 text-xs font-bold text-white transition-colors flex items-center justify-between disabled:opacity-50"
            >
          ...
          <button
            ...
            disabled={isSending}
            className="text-left px-2.5 py-2 rounded-lg bg-emerald-950/60 hover:bg-emerald-900/70 border border-emerald-500/60 text-xs font-bold text-emerald-200 transition-colors flex items-center justify-between disabled:opacity-50"
          >
        ...
        <div className="flex gap-1.5 pt-1">
          <input
            ...
            className="flex-1 bg-slate-900 border border-slate-600 rounded-lg px-3 py-2 text-xs font-semibold text-white placeholder-slate-400 focus:outline-none focus:border-rose-400"
            onKeyDown={(e) => {
          ...
          <button
            ...
            className="px-3.5 py-2 bg-rose-600 hover:bg-rose-500 disabled:opacity-50 text-white rounded-lg text-xs font-bold transition-colors shrink-0 flex items-center gap-1.5 shadow-md"
          >
